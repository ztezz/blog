  ...
  return (
    <div className="min-h-screen py-16 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        */}
        <div className="bg-white/95 dark:bg-space-900/80 backdrop-blur-xl p-8 md:p-12 rounded-3xl border border-white/20 dark:border-white/10 shadow-2xl mb-12">
            <div 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          ...
          <div className="bg-white/80 dark:bg-white/5 backdrop-blur-sm p-8 rounded-xl border border-white/40 dark:border-white/10 text-center shadow-lg dark:shadow-none hover:transform hover:-translate-y-1 transition-all">
            <Users className="mx-auto text-sky-600 dark:text-space-neon mb-4" size={32} />
          ...
          <div className="bg-white/80 dark:bg-white/5 backdrop-blur-sm p-8 rounded-xl border border-white/40 dark:border-white/10 text-center shadow-lg dark:shadow-none hover:transform hover:-translate-y-1 transition-all">
            <Target className="mx-auto text-purple-600 dark:text-space-purple mb-4" size={32} />
        ...
        {/* Team Teaser (Static) */}
        <div className="text-center bg-white/90 dark:bg-space-800/50 backdrop-blur-md p-12 rounded-2xl border border-white/40 dark:border-white/5 shadow-xl">
          ...
          <a href="/contact" className="inline-block px-8 py-3 bg-sky-500 dark:bg-transparent border border-sky-500 dark:border-space-neon text-white dark:text-space-neon font-bold rounded hover:bg-sky-600 dark:hover:bg-space-neon dark:hover:text-space-900 transition-all shadow-md">
            Liên hệ ngay
          </a>
        </div>
      </div>
